...
public class PermissionUtil {
    ...
    public static final int[] requestCodes = {REQUEST_CALENDAR, REQUEST_CAMERA, REQUEST_CONTACTS, REQUEST_LOCATION, REQUEST_MICROPHONE, REQUEST_PHONE, REQUEST_SENSORS, REQUEST_SMS, REQUEST_STORAGE};

    public static final String[] permissions = {READ_CALENDAR, CAMERA, READ_CONTACTS, ACCESS_FINE_LOCATION, CALL_PHONE, BODY_SENSORS, SEND_SMS, WRITE_EXTERNAL_STORAGE};
